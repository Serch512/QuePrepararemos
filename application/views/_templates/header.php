...
<head>
    ...
    <title>¿Que prepararemos hoy?</title>
...
<body>
    <div class="header">
                ...
                <div class="row">
                    ...
                    <img src="<?php echo URL; ?>public/img/logo.png" heigth="80px" width="80px" alt="">
                        <a href="<?php echo URL; ?>">¿Que <br/>prepararemos hoy<span class="red">?</span></a>
                    </div>
        ...
        <?php if (Session::get('user_logged_in') == true):?>
            ...
            <?php endif; ?>
            <?php if (Session::get('user_account_type') == 2 AND Session::get('user_logged_in') == true)
               :?>
